...
export default async function WorkPage() {
  const context=await getDashboardContext();const initial=(context.kind==="provider"?context.entity.portfolio:context.entity.portfolio??[]);
  return <DashboardContent>
    ...
    <WorkManager kind={context.kind} entityId={context.entity.id} initial={initial}/>
  </DashboardContent>;
}
