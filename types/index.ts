...
export interface CanonicalProviderCategory {
  id: string;
  name: string;
  slug: string;
  description: string;
...
export interface MarketplaceCategory {
  ...
  description: string;
  active: boolean;
  canonicalCategories: CanonicalProviderCategory[];
}
...
export interface Provider {
  ...
  categories?: CanonicalProviderCategory[];
  primaryCategory?: CanonicalProviderCategory;
}
