...
describe("alta asistida",()=>{
  ...
  it("exige consentimiento y categoría antes de publicar",()=>{expect(api).toContain("consent_confirmed");expect(api).toContain("Completa autorización, categoría, contacto, descripción y al menos un servicio.")});
});
